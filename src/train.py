...
# SAVING THE MODEL
# joblib installed already outside of sklearn.externals
...
# INTERPRETATION --
# From the accuracy score i.e. 100%, we see the model was able to predict correctly the species names of all the test data
